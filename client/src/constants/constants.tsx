...
export const words = [
  'apple', 'banana', 'orange', 'grape', 'kiwi', 'pineapple', 'strawberry', 'blueberry', 'watermelon', 'melon',
  'peach', 'plum', 'pear', 'cherry', 'apricot', 'lemon', 'lime', 'coconut', 'papaya', 'mango',
  'avocado', 'fig', 'nectarine', 'cranberry', 'raspberry', 'blackberry', 'elderberry', 'pomegranate', 'tangerine', 'guava',
  'dragonfruit', 'passionfruit', 'lychee', 'kiwifruit', 'starfruit', 'persimmon', 'boysenberry', 'durian', 'jackfruit', 'kumquat',
  'quince', 'mandarin', 'clementine', 'grapefruit', 'mulberry', 'rhubarb', 'honeydew', 'cantaloupe', 'muskmelon', 'huckleberry',
  'currant', 'plantain', 'date', 'custardapple', 'soursop', 'breadfruit', 'cherimoya', 'acai', 'ackee', 'bilberry',
  'blackcurrant', 'boysenberry', 'cloudberry', 'damson', 'salmonberry', 'ugli fruit', 'persimmon', 'feijoa', 'pawpaw', 'sapote',
  'longan', 'rambutan', 'lychee', 'mulberry', 'jabuticaba', 'kumquat', 'goji berry', 'ugli fruit', 'pomelo', 'tamarillo',
  'horned melon', 'loganberry', 'redcurrant', 'sea buckthorn', 'feijoa', 'medlar', 'cherimoya', 'surinam cherry', 'guinep', 'sapodilla',
  'quandong', 'saskatoon berry', 'chayote', 'physalis', 'water apple', 'amaranth', 'daikon', 'jicama', 'radicchio', 'rutabaga'
];
