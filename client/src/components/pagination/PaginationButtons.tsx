...
const PaginationButtons: React.FC<PaginationButtonsProps> = ({
  ...
  pageClassName={'inline-flex items-center justify-center border border-solid border-custom-color2 hover:bg-custom-color2 w-10 h-10 rounded-md mr-4 cursor-pointer'}
