...
const EmptyPage = () => {
  return (
    <div className="flex justify-between align-center p-16 px-56 bg-custom-color2 h-screen">
      ...
      <div className="pt-32">
        <h4 className="font-bold text-[40px]">Oops! Your post list is empty.</h4>
        <h5 className="text-[20px]">Looks like there's a blank canvas waiting for your adventures!</h5>
        <h5 className="text-[20px]">Why not share your stories, memories, or insights with us?</h5>
